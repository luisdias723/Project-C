...
<div class="body">
    <div class="container">
        ...
        <div class="main">
            ...
            <p class="opensansName">A sua inscrição para o Desfile da Mordomia foi atualizada com sucesso.</p>
            <p class="opensansName">A nossa equipa irá agora proceder à validação da sua inscrição.</p>
            <div class="direction">
                <h4>Notas:</h4>
                <ul class="notes">
