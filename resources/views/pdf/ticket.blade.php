        ...
        <tr>
            <td>
                <div style="padding-left: 30px; text-align: left;">
                    <p style="font-size: 14px; margin: 0;">Direções</p>
                    <p style="font-size: 12px; margin: 5px 0;">Antigo Governo Civil de Viana do Castelo<br>Rua da Bandeira<br>Viana do Castelo, Portugal</p>
                </div>
            </td>
        </tr>
        <tr>
